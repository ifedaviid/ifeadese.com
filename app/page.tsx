  ...
  return (
    ...
    >
      ...
      >
        <div className="flex-1">
          <p className="text-zinc-600 dark:text-zinc-400">
            Tinkering with all things creative media & digital design. Bridging the gap between design and engineering.
          </p>
        </div>
      </motion.section>
      ...
      <motion.section
        ...
        transition={TRANSITION_SECTION}
      >
        <h3 className="mb-5 text-lg font-medium">What I Do</h3>
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          {SERVICES.map((service) => (
            <div key={service.name} className="space-y-2">
              {service.image && (
                <div className="relative rounded-2xl bg-zinc-50/40 p-1 ring-1 ring-zinc-200/50 ring-inset dark:bg-zinc-950/40 dark:ring-zinc-800/50">
                  <ProjectMedia video={service.video} image={service.image} />
                </div>
              )}
              <div className="px-1">
                {service.link ? (
