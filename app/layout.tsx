...
export const metadata: Metadata = {
  metadataBase: new URL('https://ifeadese.vercel.app/'),
  alternates: {
    canonical: '/'
  },
  title: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${geist.variable} ${geistMono.variable} bg-white text-sm tracking-tight antialiased dark:bg-zinc-950`}
      >
        <ThemeProvider
          enableSystem={true}
          attribute="class"
